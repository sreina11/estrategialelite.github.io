...
symbols = [
    "BNBUSDT", "BTCUSDT", "ETHUSDT", "SOLUSDT", "DOGEUSDT", "XRPUSDT", "PEPEUSDT", "WALUSDT", "LTCUSDT", "ADAUSDT",
    "ASTERUSDT", "STOUSDT", "ZECUSDT", "PROMUSDT", "JUVUSDT", "EDENUSDT", "DEXEUSDT", "OGUSDT", "PAXGUSDT", "DASHUSDT",
    "LAUSDT", "PHBUSDT", "BATUSDT", "KERNELUSDT", "MDTUSDT", "PORTOUSDT", "DCRUSDT", "BROCCOLI714USDT", "BTTCUSDT",
    "MIRAUSDT", "INUSDT", "KGENUSDT", "ZORAUSDT", "BROCCOLIF3BUSDT", "GIGGLEUSDT", "ZENUSDT", "CUDISUSDT", "COAIUSDT", "SCRTUSDT",
    "NEARUSDT", "FILUSDT", "DOTUSDT", "UNIUSDT", "BCHUSDT", "TRXUSDT"
]
