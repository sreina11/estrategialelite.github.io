...
symbols = [
    "MBOXUSDT", "EPICUSDT", "FORMUSDT", "HYPERUSDT", "0GUSDT", "PIVXUSDT", "XPLUSDT", "SOPHUSDT", "DIAUSDT", "PENGUUSDT",
    "BTCUSDT", "ETHUSDT", "MIRAUSDT", "SOLUSDT", "BNBUSDT", "ZECUSDT", "DOGEUSDT", "XRPUSDT", "LTCUSDT", "ASTERUSDT"
]
