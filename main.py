...
symbols = [
    "MBOXUSDT", "EPICUSDT", "HYPERUSDT", "FORMUSDT", "NOMUSDT", "SOPHUSDT", "USUALUSDT", "ALCXUSDT", "AVNTUSDT", "0GUSDT",
    "BTCUSDT", "ETHUSDT", "SOLUSDT", "BNBUSDT", "XRPUSDT", "DOGEUSDT", "LTCUSDT", "MIRAUSDT", "ASTERUSDT", "ZECUSDT"
]
