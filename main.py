...
symbols = [
    "BNBUSDT", "BTCUSDT", "ETHUSDT", "SOLUSDT", "DOGEUSDT", "XRPUSDT", "PEPEUSDT", "ADAUSDT",
    "FORMUSDT", "LINKUSDT", "1000CHEEMSUSDT", "STOUSDT", "LISTAUSDT", "BMTUSDT", "ZECUSDT",
    "HEMIUSDT", "1000CATUSDT", "QTUMUSDT", "ZENUSDT", "FFUSDT", "JUVUSDT", "2ZUSDT", "WUSDT",
    "EDENUSDT", "PUMPUSDT", "AVNTUSDT", "DEXEUSDT", "MIRAUSDT", "XPLUSDT", "ASTERUSDT",
