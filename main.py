...
symbols = [
    ...
    "STOUSDT", "ZECUSDT", "ZENUSDT", "EDENUSDT", "PROMUSDT", "DASHUSDT", "PORTOUSDT", "JUVUSDT", "FUNUSDT",
    "BARDUSDT", "BERAUSDT", "PROVEUSDT", "AVNTUSDT", "HEMIUSDT", "2ZUSDT", "PUMPUSDT", "LAUSDT", "PHBUSDT",
    "LTCUSDT", "MIRAUSDT"
]
