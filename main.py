...
symbols = [
    "1000CHEEMSUSDT", "2ZUSDT", "ADAUSDT", "ALICEUSDT", "ASTERUSDT", "BATUSDT", "BNBUSDT",
    "BROCCOLI714USDT", "CAKEUSDT", "COTIUSDT", "DASHUSDT", "DEXEUSDT", "DOGEUSDT", "EDENUSDT",
    "ETHUSDT", "FORMUSDT", "KERNELUSDT", "LISTAUSDT", "MBLUSDT", "PEPEUSDT", "PIVXUSDT",
    "PUMPUSDT", "SOLUSDT", "STOUSDT", "WANUSDT", "XPLUSDT", "XPLUSDT", "XRPUSDT", "ZENUSDT",
    "ZECUSDT", "BTCUSDT"
]
