...
symbols = [
    "BNBUSDT", "BTCUSDT", "ETHUSDT", "SOLUSDT", "XRPUSDT", "DOGEUSDT", "PEPEUSDT", "LINKUSDT", "ASTERUSDT", "AVAXUSDT",
    "API3USDT", "STOUSDT", "MITOUSDT", "PIVXUSDT", "REZUSDT", "SYRUPUSDT", "FORMUSDT", "FISUSDT", "QIUSDT", "OGUSDT",
    "ALICEUSDT", "XVGUSDT", "ACXUSDT", "PENDLEUSDT", "NFPUSDT", "ZECUSDT", "ACEUSDT", "FFUSDT", "SCRTUSDT", "SHELLUSDT",
    "LTCUSDT", "MIRAUSDT", "ADAUSDT", "INUSDT", "KGENUSDT", "GIGGLEUSDT", "ZORAUSDT", "DASHUSDT", "BROCCOLIF3BUSDT",
    "ZENUSDT", "CUDISUSDT", "COAIUSDT", "NEARUSDT", "TRXUSDT", "BCHUSDT", "FILUSDT", "DOTUSDT", "ATOMUSDT"
]
