...
symbols = [
    ...
    "ADAUSDT", "TUTUSDT", "XPLUSDT", "SUIUSDT", "ASTERUSDT", "STOUSDT", "ALPINEUSDT",
    "ZECUSDT", "CAKEUSDT", "ASTRUSDT", "STRKUSDT", "ALICEUSDT", "FORMUSDT", "BROCCOLI714USDT",
    "EDENUSDT", "OPENUSDT", "BARDUSDT", "HOOKUSDT", "SOMIUSDT", "PUMPUSDT", "MITOUSDT",
    "MIRAUSDT", "ATMUSDT", "COAIUSDT", "EPTUSDT", "BLESSUSDT", "HANAUSDT", "SKYAIUSDT",
    "NAORISUSDT", "B2USDT", "QUSDT", "OPUSDT", "AAVEUSDT", "EGLDUSDT", "XLMUSDT", "AVAXUSDT",
    "LTCUSDT"
]
