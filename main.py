...
# Lista fija de activos (deduplicada y normalizada)
symbols = list(set([
...
def get_valid_volumes(symbols, sleep_time=0.1):
    volumes = []
    for symbol in symbols:
        try:
            ...
            if isinstance(data, list) and len(data) > 0:
                ...
                print(f"{symbol}: no válido o sin datos")
...
# Obtener volumen válido
top_volume = get_valid_volumes(symbols)
