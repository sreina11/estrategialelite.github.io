...
symbols = [
    "1000CHEEMSUSDT", "1000CATUSDT", "2ZUSDT", "ADAUSDT", "AIAUSDT", "ASTERUSDT", "ATMUSDT",
    "BANKUSDT", "BMTUSDT", "BNBUSDT", "BROCCOLIF3BUSDT", "BTCUSDT", "COAIUSDT", "DEXEUSDT",
    "DOGEUSDT", "EDENUSDT", "ENSUSD", "ETHUSDT", "FFUSDT", "FILUSD", "FORMUSDT", "GPSUSDT",
    "HEMIUSDT", "KOMAUSDT", "LAZIOUSDT", "LINKUSDT", "LISTAUSDT", "MIRAUSDT", "OPUSD", "PEPEUSDT",
    "PUMPUSDT", "QTUMUSDT", "RUNEUSD", "SOLUSDT", "STOUSDT", "STOUSDT", "TAKEUSDT", "TRADOORUSDT",
    "UNIUSD", "USELESSUSDT", "WUSDT", "XPLUSDT", "XPLUSDT", "XRPUSDT", "XVSUSDT", "ZECUSDT"
]
